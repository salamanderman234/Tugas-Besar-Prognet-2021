...
<body class="h-100 d-flex">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark h-100" style="width: 280px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          <li class="nav-item">
            <a href=" {{ route('profile') }}" class="nav-link text-white {{ Request::is('profile') ? 'active' : '' }}" aria-current="page">
          ...
          <li>
            <a href="{{ route('krs') }}" class="nav-link text-white {{ Request::is('krs') ? 'active' : '' }}">
          ...
          <li>
            <a href="{{ route('khs') }}" class="nav-link text-white {{ Request::is('khs') ? 'active' : '' }}">
          ...
          <li>
            <a href="{{ route('mata_kuliah')}}" class="nav-link text-white {{ Request::is('matkul') ? 'active' : '' }}">
