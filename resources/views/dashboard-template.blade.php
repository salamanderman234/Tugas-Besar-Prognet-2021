...
<body class="h-100 d-flex">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark h-100" style="width: 280px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          <li class="nav-item">
            <a href=" {{ route('profile',auth()->user()->id) }}" class="nav-link text-white active" aria-current="page">
          ...
          <li>
            <a href="{{ route('mata_kuliah',auth()->user()->id)}}" class="nav-link text-white">
        ...
        <hr>
        <a href="#" class="keluar nav-link text-white rounded">
